  ...
  return (
    <div className="TimerView">
      ...
      >
        ...
        <button id="reset" className="btn btn-warning"><div><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bootstrap-reboot" viewBox="0 0 16 16">
